...
<template>
    <div class="min-h-screen flex bg-[#F8F8FA]">
      ...
      <div class="w-full md:w-3/5 flex flex-col justify-between bg-[#F8F8FA] p-8">
        ...
        <div class="flex flex-col justify-center items-center flex-grow">
          ...
          <img class="h-48 w-auto mb-6" src="../assets/img/logoTwo.png" alt="CEPRO HUANCANÉ Logo">
        </div>
      </div>
        ...
        <div class="w-full mx-auto">
          ...
          <div class="mt-6 text-center">
            <p class="text-sm text-[#49454F]">
              <strong>¿Olvidaste Tu Cuenta? <a href="#" class="font-bold text-[#921733]">Recupera Aquí</a></strong>
            </p>
          </div>
          ...
          <p class="mt-6 text-center text-sm text-[#49454F]">
            ...
            <strong>
              <a href="#" class="font-bold text-[#921733] underline">Términos de Servicio</a> y
              <a href="#" class="font-bold text-[#921733] underline">Políticas de Privacidad</a>.
            </strong>
          </p>
        </div>
      </div>
