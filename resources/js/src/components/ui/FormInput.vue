...
<template>
  ...
  >
    <input
      ...
      class="bg-gray-50 border border-gray-300 sm:text-sm rounded-sm block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 focus:ring-0.5 focus:ring-active focus:border-active dark:focus:ring-active dark:focus:border-active outline-none"
