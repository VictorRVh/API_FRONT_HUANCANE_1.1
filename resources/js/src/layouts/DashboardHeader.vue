...
<template>
    <div class="flex flex-col min-h-screen bg-blancoPuro dark:bg-gray-800 text-granate dark:text-gray-400 font-inter w-12/12 max-w-3xl">

      <!-- Título "HERRAMIENTAS" -->
      <h2 class="text-lg font-semibold text-negroClaro dark:text-gray-400 mt-4 mb-2 pl-4">Menù</h2>
        ...
        >
          <template v-slot="{ isActive }">
            <span
              ...
              :class="[isActive ? 'mt-2 border-b border-b-granate text-granate dark:text-white' : 'text-granate dark:text-gray-400']"
            >
